...
export default function SharedBannerSection({ trailingTitle, trailingSubtitle, buttons, textAlign = "left" }: SharedBannerSectionProps) {
  return (
    <Box sx={{ backgroundColor: '#000000', width: '100%', pt: { xs: 12, md: 20 }, pb: { xs: 12, md: 20 } }}>
      <Container maxWidth="xl" sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
        <Box sx={{ maxWidth: '1233px', width: '100%', textAlign: textAlign, px: { xs: 2, xl: 0 } }}>
          <Typography data-aos="fade-up" sx={{ maxWidth: '1137px', mx: textAlign === "center" ? "auto" : 0, color: '#FFFFFF', fontWeight: 700, fontFamily: '"DM Sans", sans-serif', fontSize: { xs: '24px', md: '48px' }, lineHeight: { xs: 1.4, md: 1.4}, letterSpacing: '-2.4px', mb: '24px' }}>
            {trailingTitle}
          </Typography>
